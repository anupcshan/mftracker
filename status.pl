...
sub getstatusformf() {
	...
	printf ("%40s %8.3f %10.3f %8.3f %8.3f %10.3f\n", $mfname, $quantity, $total, $avgbuyprice, $currentprice, $currentvalue);
	return ($total, $currentvalue);
}

sub getstatusbymf() {
	print "=" x 89, "\n";
	printf ("%40s %8s %10s %8s %8s %10s\n", 'Name', 'Units', 'Total', 'Avg Cost', 'Cur Cost', 'Cur Value');
	print "-" x 89, "\n";
	...
	print "-" x 89, "\n";
	printf ("%40s %19.3f %28.3f\n", 'Total', $totalbuyvalue, $totalcurrentvalue);
	print "=" x 89, "\n";
}
